...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); //collego listener ai pulsanti visibilità
...
function standBy(slug) {
  ...
  var elements = $('[data-slug="' + slug + '"] .mytoggle_state');
  elements.off();
...
function setState(slug, onState) {
  ...
  var onStateElement = $('[data-slug="' + slug + '"] .on_state');
  var offStateElement = $('[data-slug="' + slug + '"] .off_state');
...
function showMessage(message) {
  var messageElement = $('#message_label');
...
function deleteApartment(element) {
  ...
  var url = 'http://127.0.0.1:8000/api/apartment/delete';
  $.ajax(url, {
    method: 'DELETE',
    headers: {
      'X-Requested-With': 'XMLHttpRequest',
...
module.exports = __webpack_require__(/*! /home/parallels/Desktop/Boolean/sites/progetto-finale/class3-project/resources/js/dashboard.js */"./resources/js/dashboard.js");
