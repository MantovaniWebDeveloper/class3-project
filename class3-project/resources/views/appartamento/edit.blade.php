...
@section('content')
    ...
    <div class="container custom-form">
        ...
        <div class="col-12 border-top border-dark pt-4">
          <form class="form-group" action="{{route('salva.modifica', $apartment->id)}}" method="post" enctype="multipart/form-data">
            <h3>Form appartamento</h3>
              ...
              <!-- BLOCCO GEO -->
              <div class="form-group border-top border-dark pt-4">
                <h3>Geolocalizzazione</h3>
                <div class="row">
                  <div class="col-4">
                    <div class="apartment_map">
                      <img id="tomtom_map_big" src="data:image/png;charset=binary;base64,{!! $image !!}">
                      <i id="marker" class="fas fa-map-marker-alt"></i>
                    </div>
                    <p>
                      <i class="fas fa-map-marker-alt pr-2 "></i><small>{{$apartment->address['streetName']}} {{$apartment->address['postal_code']}} {{$apartment->address['municipality']}} - {{$apartment->address['province']}}</small>
                    </p>
                  </div>
                  <div class="form-group col-4">
                    <div class="form-group">
                      <label for="address">Inserisci l'indirizzo dell'appartamento</label>
                      <input class="form-control col-10" id="user_address" type="text" name="address" placeholder="digita l'indirizzo">
                    </div>
              ...
              <div class="form-group border-top border-bottom border-dark pt-4 pb-4">
                <h3>Upload Foto</h3>
            ...
            <div class="buttons_section  pt-4">
